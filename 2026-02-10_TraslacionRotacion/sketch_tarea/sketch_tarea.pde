...
void draw() {
  ...
  dx = puntos[1].x - cuadrado.x;
  dy = puntos[1].y - cuadrado.y;
  cuadrado.Traslacion(dx, dy);
  cuadrado.Dibujar();
  // Aquí llegamos al punto 3
  dx = puntos[2].x - cuadrado.x;
  dy = puntos[2].y - cuadrado.y;
  cuadrado.Traslacion(dx, dy);
  cuadrado.Dibujar();
  // Aquí llegamos al punto 4
  dx = puntos[3].x - cuadrado.x;
  dy = puntos[3].y - cuadrado.y;
  cuadrado.Traslacion(dx, dy);
  cuadrado.Dibujar();
